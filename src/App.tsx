        ...
        <div className="shell">
          <section className="hero">
            ...
            <p className="hero-context">
              ...
              dan ortiq jamoaga mahsulotni ishga tushirish, mijoz topish va
              investitsiya jalb qilishda ko‘maklashdik. Founders Residency’da
              biz imkoniyatni topamiz va tekshiramiz, jamoa yig‘amiz, mahsulot
              va tarqatish strategiyasini tayyorlaymiz — so‘ng loyihani boshdan
          ...
          <section className="apply" id="ariza">
            <div className="apply-head">
              ...
              <p className="apply-lead">
                Bizga sayqallangan matn emas — ijro dalili kerak. Har bir
                savolga qisqa, aniq va o‘z so‘zlaringiz bilan javob bering.
              </p>
            </div>
            <ApplicationForm />
          </section>
